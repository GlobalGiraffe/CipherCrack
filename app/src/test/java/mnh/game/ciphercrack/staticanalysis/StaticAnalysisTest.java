...
public class StaticAnalysisTest {
    ...
    public void testFrequencyAndIOC() {
        ...
        ioc = StaticAnalysis.calculateIOC(sampleString, defaultAlphabet);
    ...
    public void testGetIOC() {
        ...
        String englishLikeSampleFromWeb = "WKHUH DUHWZ RZDBV RIFRQ VWUXF WLQJD VRIWZ DUHGH VLJQR QHZDB\n" +
                ...
                "LFXOW";
        double ioc = StaticAnalysis.calculateIOC(englishLikeSampleFromWeb, english.getAlphabet());
        assertEquals("IOC English Text 1", 0.06810, ioc, delta);

        String simpleMessage = "WHENTHECLOCKSTRIKESTWELVEATTACK";
        ioc = StaticAnalysis.calculateIOC(simpleMessage, english.getAlphabet());
        ...
        ioc = StaticAnalysis.calculateIOC(dutchMessage, dutch.getAlphabet());
    ...
    public void testGetIOCEmpty() {
        double delta = 1e-10;
        double ioc = StaticAnalysis.calculateIOC("", defaultAlphabet);
        assertEquals("IOC Empty Text", 0.0, ioc, delta);
        ioc = StaticAnalysis.calculateIOC(null, defaultAlphabet);
    ...
    public void testGetCyclicIOC() {
        ...
        double[] ioc = StaticAnalysis.getCyclicIOC(text, null, defaultAlphabet);
